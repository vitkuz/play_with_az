...
Az.Morph.init('./node_modules/az/dicts', function() {
    ...
    const quote = {
        ...
        author:[],
        stories:[],
        questions:["Как спасти человечество?", "Каким должно быть будущее?"],
        tags:[],
        categories: ['О будущем', 'О человечестве', 'О космосе'],
        intent: 'Как спасти человечество?',
        text_ru: `База на Марсе будет находиться достаточно далеко от Земли и с большей вероятностью останется целой [в случае войны], нежели база на Луне.`,
        uuid: 1,
        tokenized: null,
        nouns:[],
        verbs:[],
